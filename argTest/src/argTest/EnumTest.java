...
/*
 * 상수명에다 이름을 부여하면 데이터가 의미하는 것을 쉽게 알 수 있다
 * 
 * Enum(열거형) ==> 서로 관련이 있는 상수들의 집합을 나타낸다.
 * 			  ==> 클래스처럼 보이게 하는 상수
 ...
 * 
 * 			ordinal() : 열거형 상수가 정의된 순서 값(==index값)을 반호나열한다 (index는 0부터 시작)
 * 
 * 			valueOf("열거형상수명") : 저장된 열거형에서 '열거형상수명'과 일치하는 열거형 상수를 반환한다
 * 			
 ...
 *
 *		방법2) 상수의 값들을 대입하여 사용하고 싶을 때 사용한다
 *			enum 열거형이름{ 상수명1(값들....)
 *							상수명2(값들....)
 *							상수명3(값들....)
 *							...
 ...
 * 								}
 * 
 * 			//3. 구성된 '값들'을 외부에서 불러올 수 있는 getter메서드를 만든다
 * 
 * */
...
public class EnumTest {
	...
	public enum Season{
		...
		//2.생성자를 만든다  private를 생략해도 내부적으로 생성된다
		Season(String month, int num){
			span = month;
			this.num = num;	
	...
	public static void main(String[] args) {
		...
		System.out.println("[열거형 선언 방법 1]");
...
//		if(mycol == mycnt)
		...
		System.out.println("[열거형 선언 방법 2]");
		...
		//열거형 이름.values() ==> 모든 상수들을 배열로 가져온다
