...
public class Aes256Util {
	...
	//ASE256방식으로 암호화 하는 메서드
	public String encrypt(String str) throws NoSuchAlgorithmException, GeneralSecurityException, UnsupportedEncodingException{
		
		//Cipher 객체 생성
		//형식) 알고리즘/모드/패딩
		// 	CBC : Cipher Block Chainning Mode ==> 동일한 평문 블록과 암호문 블록 쌍이 발생하지 않도록 
		// 			이전 단계의 암호화 복호화한 결과가 현 단계에 영향을 주는 운영 모드를 말한다
		// 		패딩 padding : ==> 마지막 블록이  블록의 길이와 항상 딱 맞아 떨어지지 않기 때문에 부족한 길이 만큼 
//								'0'으로 채우거나 임의의 비트로 채워 넣는 것을 의미한다.
