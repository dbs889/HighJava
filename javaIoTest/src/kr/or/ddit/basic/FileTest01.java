...
//		File file1  = new File("D:/D_other/test.txt");	//구분문자룰 '/'로 사용
		File file1  = new File("D:\\D_other\\text.txt");//구분문자를 '\'로 사용   ==> java에서는 \를 두개 사용해서 쓴다
		
		
		System.out.println("파일명 : " + file1.getName());
		System.out.println("경로(path) : " + file1.getPath());
		...
		System.out.println("경로(path) : " + file2.getPath());
		...
		//		==> 'parent' 디렉토리안에 있는 'child'파일을 찾는다
		
		
		File file3 = new File(file2, "text.txt");
		System.out.println("파일명 : " + file3.getName());
		System.out.println("경로(path) : " + file3.getPath());
		...
		System.out.println("경로(path) : " + file4.getPath());
		...
		System.out.println(file5.getName() + " 의 존재여부 : " + file5.exists()); //exist가 false이면 폴더안에 파일이 없다
